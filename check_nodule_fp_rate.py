...
from dsets import Luna2dSegmentationDataset, getCt, getCandidateInfoList, getCandidateInfoDict, \
    CandidateInfoTuple, LunaDataset
...
class FalsePosRateCheckApp:
    ...
    def initModels(self):
        ...
        cls_model.load_state_dict(cls_dict['model_state'], strict=False)
        cls_model.eval()
